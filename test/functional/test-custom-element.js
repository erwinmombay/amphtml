...
describe('CustomElement Loading Indicator', () => {
  ...
  it('should create and turn on', () => {
    ...
    vsyncTasks.shift()();
    expect(element.loadingContainer_).to.not.be.undefined;
    expect(element.loadingContainer_).to.not.have.class('amp-hidden');
    expect(element.loadingElement_).to.not.be.undefined;
  ...
  it('should turn off and cleanup', () => {
    ...
    expect(vsyncTasks).to.have.length.of(1);
    vsyncTasks.shift()();
    expect(element.loadingContainer_).to.be.undefined;
    expect(element.loadingElement_).to.be.undefined;
  });
